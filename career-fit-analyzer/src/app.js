import { JOB_DESCRIPTIONS } from "../data/jobDescriptions.js?v=resume-based-20260511";
import { RESUME_PROFILE, analyzeGap, recommendProjectFocus } from "./analyzer.js?v=resume-based-20260511";
